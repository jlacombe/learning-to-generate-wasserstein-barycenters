...
KEY = '50213149dec66b8f62240e86e660d9a0'
SECRET = 'd1800b5f6ac96c22'

# SIZES = ['url_o', 'url_k', 'url_h']  # in order of preference
...
def download(queries, images_per_query):
    for query in queries:
        ...
        path = os.path.join('..', 'datasets', 'flickr_bis', 'imgs', query)
