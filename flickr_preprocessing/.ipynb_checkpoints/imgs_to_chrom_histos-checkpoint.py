...
#     print(img_path)
    ...
    histo = get_chrominance_histo(a, b, range_a, range_b, histo_size)
...
#             print(np.unique(np.stack(histos)))
#             print(np.unique(histos_dset[i:i+batch_size]))
#             print(imgs_paths_dset[i:i+batch_size])
